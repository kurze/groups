use actix_web::{get, web, post, delete, put, HttpResponse, Responder};
            ...
            match service.update(group) {
                Ok(_) => {
                    ...
                    match service.get_by_id(group_id) {
                        ...
                        _ => HttpResponse::InternalServerError().body("Failed to retrieve updated group"),
                    }
                },
                Err(e) => HttpResponse::InternalServerError().body(format!("Database error: {}", e)),
            }
...
mod tests {
    ...
    use crate::db::models::Group; // Import the Group type

    // Add a mock service for testing error conditions
    ...
    async fn test_get_group() {
        ...
        let db = Arc::new(Builder::new().create_in_memory(&crate::db::models::MODELS).unwrap());
